<?
    ...
    `NL_PROP_RESALE_FLOOR` AS FLOOR, `NL_PROP_RESALE_PHOTO_URLS` AS PHOTOS, `NL_PROP_RESALE_COST_TOTAL` AS COST, `NL_PROP_RESALE_AREA_FULL` AS AREA, `NL_PROP_RESALE_ADDRESS` AS ADRESS, `NL_PROP_RESALE_DESCRIPTION` AS DESCRIPTION, `NL_PROP_RESALE_PHONE` AS PHONE
    FROM `NL_PROP_RESALE`";
